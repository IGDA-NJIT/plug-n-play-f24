...
@export var world_map_scene: PackedScene = preload("res://DONOTEDITME/game/sample/level_selector.tscn")
var level_array: Array[PackedScene] = [
	...
	preload("res://DONOTEDITME/game/sample/test_environment.tscn"),
